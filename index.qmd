...
- Java/Scala & Python
- Im Gegensatz zu Hadoop: keine Zwischenergebnisse auf Platte
- Modell: Fluss von Daten durch mehrere Verarbeitungsstufen 
```{mermaid}
flowchart LR
...
- Auch Dataflow Computing oder reaktive Programmierung
- Abstraktion: Operationen als Knoten und Datenabhängigkeiten als Kanten eines Graphen
- `f(x, y, z) = x * y + z`
- sd
- [@Schwarzkopf_RemarkableUtility_2020]
